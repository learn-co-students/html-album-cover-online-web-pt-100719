RSpec.describe 'HTML Album Cover' do
    ...
    context 'within <body>' do
      ...
      it 'the back section contains the correct header sizes and text content' do
        ...
        expect(back_cover.children.select {|ch| ch.name == "img"}[0].attributes["src"].value).to be == 'images/columbia-logo.png', "First image should have its source set to 'https://s3.amazonaws.com/learn-verified/columbia-logo.png'"
        ...
        expect(back_cover.children.select {|ch| ch.name == "img"}[1].attributes["src"].value).to be == 'images/song-logo.png', "First image should have its source set to 'https://s3.amazonaws.com/learn-verified/columbia-logo.png'"
